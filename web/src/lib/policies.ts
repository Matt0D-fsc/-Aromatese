...
export const POLICY_FIELDS = [
  {
    ...
    placeholder: '60 taka',
    hint: 'One amount, like "60 taka" or "Free", is added to every order the AI takes. Anything else ("60-80", "depends") and the AI says you confirm it by phone.',
  },
  { key: 'deliveryOutsideDhaka', label: 'Delivery charge outside Dhaka', placeholder: '120 taka', hint: 'Same rule: one amount is added to the order.' },
